      ...
      <div className="all_menu_wrap scrollbar">
        <div className="all_left">
          ...
          <div className="all_menu_group">
            ...
            {menu.slice(0, 6).map(({ name, icon, description }, i) => (
              <AllMenuItem
                name={name}
                icon={icon}
          ...
          <div className="all_menu_group">
            ...
            {menu.slice(7, 9).map(({ name, icon, description }, i) => (
              <AllMenuItem
                name={name}
                icon={icon}
                description={description}
          ...
          <div className="all_menu_group">
            ...
            {menu.slice(9, 11).map(({ name, icon, description }, i) => (
              <AllMenuItem
                name={name}
                icon={icon}
                description={description}
          ...
          <div className="all_menu_group">
            ...
            {menu.slice(11, 15).map(({ name, icon, description }, i) => (
              <AllMenuItem
                name={name}
                icon={icon}
                description={description}
          ...
          <div className="all_menu_group">
            ...
            {menu.slice(15, 17).map(({ name, icon, description }, i) => (
              <AllMenuItem
                name={name}
                icon={icon}
                description={description}
          ...
          <div className="all_menu_group">
            ...
            {menu.slice(17, 21).map(({ name, icon, description }, i) => (
              <AllMenuItem
                name={name}
                icon={icon}
                description={description}
          ...
          <div className="all_menu_group">
            ...
            {menu.slice(21, 23).map(({ name, icon, description }, i) => (
              <AllMenuItem
                name={name}
                icon={icon}
                description={description}
